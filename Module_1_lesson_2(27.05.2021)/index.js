...
// const userNumber = +prompt('Какое количество месяцев в году');
// let message = userNumber === 12 ? 'Верно' : 'Не знаете ? 12!';
// console.log(message);

// // Написать программу которая получит от пользователя число и определит четное это число или не четное.

// const getNumber = prompt('Enter u number')
// let message = getNumber % 2===0 ? 'четное' : 'нечетное'
// console.log(message)     
